...
<body>
    ...
    <div class="m-5">
        <h1 class="text-success w-75 m-auto">Update {{ $student->name }} Data</h1>
    </div>

    <form method="POST" action="{{ route('students.update', $student->id) }}" class="w-75 m-auto border p-2" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <div class="mt-2">
                <img src="{{ asset('uploads/students/' . $student->image) }}" alt="Current Image" width="100">
            </div>
        </div>
