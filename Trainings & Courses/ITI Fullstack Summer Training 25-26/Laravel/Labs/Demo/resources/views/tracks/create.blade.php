...
<body>
    ...
    <div class="mb-3">
            <label for="exampleInputdescription" class="form-label">Courses</label>
            <input type="text" name="courses[0]" value="{{ $track->id }}" >
         <input type="text" name="courses[1]" value="{{ $track->id }}" >
            <input type="text" name="courses[2]" value="{{ $track->id }}" >
